...
typedef struct
{
  union {
    ...
    __IO uint32_t FIODIR32;
    struct {
      __IO uint16_t FIODIRL;
      __IO uint16_t FIODIRH;
    };
    struct {
      __IO uint16_t FIODIR16[2];
    };
    struct {
    ...
    struct {
      __IO uint8_t  FIODIR8[4];
    };
  };
  uint32_t RESERVED0[3];
  union {
    __IO uint32_t FIOMASK;
    __IO uint32_t FIOMASK32;
    struct {
      __IO uint16_t FIOMASKL;
      __IO uint16_t FIOMASKH;
    };
    struct {
      __IO uint16_t FIOMASK16[2];
    };
    struct {
    ...
    struct {
      __IO uint8_t  FIOMASK8[4];
    };
  };
  union {
    __IO uint32_t FIOPIN;
    __IO uint32_t FIOPIN32;
    struct {
      __IO uint16_t FIOPINL;
      __IO uint16_t FIOPINH;
    };
    struct {
      __IO uint16_t FIOPIN16[2];
    };
    struct {
    ...
    struct {
      __IO uint8_t  FIOPIN8[4];
    };
  };
  union {
    __IO uint32_t FIOSET;
    __IO uint32_t FIOSET32;
    struct {
      __IO uint16_t FIOSETL;
      __IO uint16_t FIOSETH;
    };
    struct {
      __IO uint16_t FIOSET16[2];
    };
    struct {
    ...
    struct {
      __IO uint8_t  FIOSET8[4];
    };
  };
  union {
    __O  uint32_t FIOCLR;
    __O  uint32_t FIOCLR32;
    struct {
      __O  uint16_t FIOCLRL;
      __O  uint16_t FIOCLRH;
    };
    struct {
      __O  uint16_t FIOCLR16[2];
    };
    struct {
      __O  uint8_t  FIOCLR0;
      __O  uint8_t  FIOCLR1;
...
typedef struct                          /* Common Registers                   */
{
  ...
  LPC_GPDMACH_TypeDef Channels[8];
} LPC_GPDMA_TypeDef;
...
typedef struct
{
  ...
  __I  uint32_t OTGIntSt;               /* 0x100: USB On-The-Go Registers     */
  __IO uint32_t OTGIntEn;
  __O  uint32_t OTGIntSet;
  __O  uint32_t OTGIntClr;
  union {
  __IO uint32_t OTGStCtrl;              /* 0x110 */
  ...
  union {
  __IO uint32_t USBClkCtrl;             /* 0xFF4: USB Clock Control Registers */
...
#define LPC_TIM0              ((LPC_TMR_TypeDef       *) LPC_TIM0_BASE     )
#define LPC_TIM1              ((LPC_TMR_TypeDef       *) LPC_TIM1_BASE     )
#define LPC_TIM2              ((LPC_TMR_TypeDef       *) LPC_TIM2_BASE     )
#define LPC_TIM3              ((LPC_TMR_TypeDef       *) LPC_TIM3_BASE     )
...
#define LPC_FLASHSIG          ((LPC_FLASHSIG_TypeDef  *) LPC_FLASHSIG_BASE )
